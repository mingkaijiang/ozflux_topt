...
{
  setwd(paste("~/Documents/Research/Projects/ozflux/", sitename, sep=""))
  
  ##############################################################################
  
  ##Read Ozflux data 
  tmet <- nc_open(paste0("~/Documents/Research/Data/OzFlux/",sitename,"OzFlux2.0_met.nc"))
  #print(tmet)
  ...
  tflx <- nc_open(paste0("~/Documents/PostDoc/OzFlux/",sitename,"OzFlux2.0_flux.nc"))
