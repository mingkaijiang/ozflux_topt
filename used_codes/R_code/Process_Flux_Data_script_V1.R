...
##############################################################################
#source("~/Documents/PostDoc/OzFlux/R_code/Process_Flux_Data_function_V1.R")
##############################################################################
...
rain <- get.var.ncdf(tmet,"Rainf")*1800    ##if hourly, change to 3600
